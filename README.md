# 1.项目介绍
- 系统角色：管理员、商户
- 功能模块：用户管理、商户管理、鲜花分类管理、鲜花管理、订单管理、收藏管理、购物车、充值、下单等
...
- 配置tomcat，启动项目，其中，我将deployment下的application contex配置为 /ssm67m8n
- http://localhost:8080/ssm67m8n/admin/dist/index.html   管理员账号密码：abo/abo， 其他自行查表
